...
<td>
<a href = "{{route('projects.show',$newNote->relatesToProject->id)}}" title="Review {{$newNote->relatesToProject->project_title}} project" >{{$newNote->relatesToProject->project_title}}</a>
</td>
<td>
{{$newNote->relatesToProject->fullAddress()}}
</td>
<td>
{{$newNote->note}}
</td>
