<div style="border:1px solid #000;width:600px;margin:20px;padding:20px;float:left">
  <h4>Lead Notes in past month</h4>
    ...
    <tbody>
      @foreach($data['recentLeadNotes'] as $newNote)
          <tr>
              ...
              <td>
                <a href = "{{route('leads.show',$newNote->relatesToLead->id)}}"
                 title="Review {{$newNote->relatesToLead->businessname}} lead" >
                  {{$newNote->relatesToLead->businessname}}
               </a>
              </td>
