    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content modal-sm">
            ...
            <div class="modal-body">
               @foreach ($news as $new)
                <h4>{{$new->title}}</h4>
                <p>Dateline: {{date('M jS, Y'  ,strtotime($new->startdate))}}</p>
            ...
            <div class='pull-left'><input type='checkbox' id='nonews' name='noNews' />Check if you don't want to see any more old news!</div>
