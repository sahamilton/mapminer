...
<p>
<a href="{{route('exportlocationnotes',$companyID)}}" title="Download {{$data['title']}} as a CSV / Excel file"><i class="far fa-cloud-download" aria-hidden="true"></i></i> Download {{$data['title']}}</a>
</p>
