...
<a href="{{route('company.watchexport')}}?id='{{strip_tags($data['accountstring'])}}'" title="Download {{$data['title']}}watch list as a CSV / Excel file"><i class="far fa-cloud-download" aria-hidden="true"></i></i> Download Watch List</a>
