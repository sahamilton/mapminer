...
{{Form::select('businesstype',$businesstypes,isset($location->businesstype) ? $location->businesstype : $nullBusinesstype )}}
...
<!-- Form Actions -->
	<div style="margin-top:20px">
		<div class="controls">
			<a class="btn btn-link" href="{{ route('company.show',$location->company_id) }}">Cancel</a>
