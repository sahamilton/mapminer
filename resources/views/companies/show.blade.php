...
<p>Account managed by <a href="{{route('person.show',$data['company']->managedBy->id)}}" title="See all accounts managed by {{$data['company']->managedBy->fullName()}}">{{$data['company']->managedBy->fullName()}}</a></p>
@endif
