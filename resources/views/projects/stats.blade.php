...
<p><a href= "{{route('project.exportstats')}}"> Export Stats</a> |
<a href="{{route('projects.status')}}">See all owned projects</a> | 
<a href="{{route('projectsource.index')}}">See all project sources</a></p>
<?php $person = null;?>
