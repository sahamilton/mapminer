...
<p><a href="{{route('projects.export')}}" title="Download my claimed projects as a CSV / Excel file"><i class="far fa-cloud-download" aria-hidden="true"></i></i> Download My Projects</a>
