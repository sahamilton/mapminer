<div class="row">
  <div id="series_chart_div" 
   style="width: 40%;float:left;border:solid 1px #aaaaaa;margin-bottom: 5px"> 
   <h4>Wins vs Sales Appts</h4>
    @include('opportunities.partials._bubble')
  </div>

  
    <div style="width: 40%;float:right;border:solid 1px #aaaaaa;margin-bottom: 5px;margin-left:5px">
...
<div style="width: 40%;float:left;border:solid 1px #aaaaaa">
