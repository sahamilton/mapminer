<nav class="flex w-100 h-30" >
    ...
    <a href="{{ route('welcome') }}" class="pt-4 pl-4"><img src="{{ asset('assets/img/PRlogo.png')}}"  width ='164'>
    </a> <!--     <nav class="navbar navbar-toggleable-sm navbar-light bg-faded">
    ...
    <ul class="flex justify-around items-center mt-2 ml-12 h-20 w-50"> 
     ...
     @else
      ...
      <li class="flex justify-center items-center">
            <button 
                type="button"
                class="text-lg text-gray-600 group inline-flex items-center space-x-2 text-base leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900" id="navbarDropdownMenuLink"
                data-toggle="dropdown"
                aria-haspopup="true"
                aria-expanded="false">
                  <span><i class="fas fa-search"></i> Searchi</span>
          ...
          <div class="dropdown-menu p-3 top-12" aria-labelledby="navbarDropdownMenuLink">
            ...
            <a class="dropdown-item p-2" href="{{{ route('findme') }}}">
              <i class="far fa-map" aria-hidden="true"> </i> Maps
            </a>
          
            <a class="dropdown-item p-2" href="{{{ route('company.index') }}}">
              <i class="far fa-building" aria-hidden="true"> </i> Accounts
            </a>
    
            <a class="dropdown-item p-2" href="{{{ route('branches.map') }}}">
              <i class="fab fa-pagelines"></i> Branches
           </a>

            <a class="dropdown-item p-2" href="{{route('salesorg.index')}}">
                  <i class="fas fa-sitemap" aria-hidden="true"> </i>People
            </a>
            @if(auth()->user()->hasRole('branch_manager'))
            <a class="dropdown-item" href="{{route('search.leads')}}">
                  <i class="fas fa-arrow-right" aria-hidden="true"> </i>Leads
            </a>
            @endif
        ...
        <li class="nav-item dropdown">
            ...
            <button type="button"
              class="text-base text-gray-600 group inline-flex items-center space-x-2 leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150" id="navbarDropdownMenuLink"
              data-toggle="dropdown"
              aria-haspopup="true"
              aria-expanded="false">
              ...
              <div class="dropdown-menu p-3" aria-labelledby="navbarDropdownMenuLink">
                  ...
                  <a class="dropdown-item p-2" href="{{{ route('dashboard.index') }}}">
                    <i class="fas fa-tachometer-alt"></i> 
                    My Dashboard
                  </a>

                  <a class="dropdown-item p-2" href="{{{ route('branchcampaigns.index') }}}">
        ...
        <li class="nav-item dropdown">
            <button type="button"
              class="text-gray-600 group inline-flex items-center space-x-2 text-base leading-6 font-medium hover:text-gray-900 focus:outline-none focus:text-gray-900 transition ease-in-out duration-150" id="navbarDropdownMenuLink"
              data-toggle="dropdown"
              aria-haspopup="true"
              aria-expanded="false">
            ...
            <div class="dropdown-menu p-3" aria-labelledby="navbarDropdownMenuLink">
                ...
                <a class="dropdown-item" href="{{route('branch.leads')}}">
                    <i class="fas fa-arrow-right"></i> Branch Leads
                </a>
                ...
                <a class="dropdown-item p-2"  href="{{route('opportunity.index')}}">
                 ...
                 <a class="dropdown-item p-2" href="{{route('contacts.index')}}">
                    <i class="far fa-address-card"></i> Branch Contacts
                  </a>

                  <a class="dropdown-item p-2" href="{{ route('activity.index') }}">
                    <i class="far fa-calendar-alt"></i> Branch Activities
                  </a>

                  <a class="dropdown-item p-2" href="{{ route('orders.index') }}">
                    <i class="far fa-calendar-alt"></i> Branch Accounts
                  </a>
                  @endCan
              ...
              <li class="nav-item">
                  <a class="nav-link" 
                      ...
                      <i class="fas fa-plus" style="color:green"> </i> Add Lead
                  </a>
              </li>
