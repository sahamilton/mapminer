...
class AdminUsersController extends BaseController
{
     ...
     * @return [type]         [description]
     */
    private function _updateAssociatedPerson($person, $data)
    {
     ...
     * 
     * @param User   $user             [description]
     * @param Array $branchesServiced [description]
     * 
     * @return [type]                   [description]
     */
    private function _getUsersBranches(User $user, Array $branchesServiced = null)
    {
