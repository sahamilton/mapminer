...
class Geolocation
{
     ...
     * argument.
     */
    public function distanceTo(self $location, $unit_of_measurement)
    {
    ...
    public function boundingCoordinates($distance, $unit_of_measurement = 'mi')
    {
        ...
        $coordinates = ['min'=>$this->fromRadians($minLat, $minLon),
                    'max'=>$this->fromRadians($maxLat, $maxLon), ];
